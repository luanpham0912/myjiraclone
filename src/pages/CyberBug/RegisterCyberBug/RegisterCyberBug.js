  ...
  return (
    <form onSubmit={handleSubmit} className='container'>
      <div style={{ height: window.innerHeight }} className='d-flex justify-content-center align-items-center flex-column'>
        ...
        <Input required onChange={handleChange} type='email' size="large" name='email' placeholder="email" prefix={<UserOutlined />} style={{ width: "50%", marginBottom: "20px" }} />
        <div className='text-danger'>{errors.email}</div>
        <Input required onChange={handleChange} type='password' size="large" name='password' placeholder="password" prefix={<LockOutlined />} style={{ width: "50%", margin: "20px 0" }} />
        <div className='text-danger'>{errors.password}</div>
        <Input required onChange={handleChange} type='text' size="large" name='name' placeholder="name" prefix={<UserOutlined />} style={{ width: "50%", margin: "20px 0" }} />
        <div className='text-danger'>{errors.name}</div>
        <Input required onChange={handleChange} type='text' size="large" name='phone' placeholder="phone" prefix={<PhoneOutlined />} style={{ width: "50%", margin: "20px 0" }} />
